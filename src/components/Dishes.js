...
const Dishes = () => {
  ...
  return (
    ...
    <p className='error'>{errors.name?.type === 'required' && "Dish Name is required"}</p>
    <div className="form-group">
        <input className="form-input" type="text"  {...register("name", { required: true })}  />
        <label className="form-label">Dish name</label>
    </div>
    <p className='error'>{errors.preparation_time?.type === 'required' && "Time is required"}</p>
    <div className="form-group">
    <input className="form-input-2" type="time"  step="1"  {...register("preparation_time", { required: true })} defaultValue="00:00:00"/>
        <label className="form-label">Time</label>
    </div>
    <div className="form-group">
    <select className="form-input-2" value={selectedDishType}
